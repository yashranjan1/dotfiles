...
export class NotificationMap implements Subscribable {
    ...
    private getExistingNotifs: boolean
    ...
    constructor(getExistingNotifs: boolean = false) {

        this.getExistingNotifs = getExistingNotifs

        const notifd = Notifd.get_default()

        if (this.getExistingNotifs) {
            notifd.get_notifications().forEach(notif => {
                this.set(notif.id, Notification({
                    notification: notifd.get_notification(notif.id)!,
